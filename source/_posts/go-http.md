...
在这里，笔者无意争论谁对谁错，只是提出一套自己通过实践总结出来的思路，与读者分享。

框架的意义
====

刚开始接触Go语言的时候，当时笔者所面对的情况是“急需快速实现一个HTTP服务的需求“。
...
完整代码参考： https://github.com/mapleque/gostart/blob/master/http/todolist/todolist.go

下面是关键代码，思路和细节请仔细阅读代码注释部分。
{% endnote %}
